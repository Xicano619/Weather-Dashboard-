...
function fiveDayWeather(city){
    ...
    $.ajax({
        ...
        // Create vars for day2 forecast
        var forCas2F = (response.list[8].main.temp - 273.15) * 1.80 + 32;
        ...
        var forCas3F = (response.list[16].main.temp - 273.15) * 1.80 + 32;
        ...
        var forCas4F = (response.list[24].main.temp - 273.15) * 1.80 + 32;
        ...
        var forCas5F = (response.list[32].main.temp - 273.15) * 1.80 + 32;
